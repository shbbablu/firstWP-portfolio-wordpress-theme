...
function first_setup() {
    ...
    add_image_size( 'post-thumbnail-large', 750, 500, true);        

	// This theme uses wp_nav_menu() in one location.
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'first' ),
	) );
...
if( file_exists( dirname(__FILE__ ) . '/inc/plugins/example.php')){
    require_once get_template_directory() . '/inc/plugins/example.php';
}

/**
 * Enqueue scripts and styles. All the style & scripts are there.
 */
